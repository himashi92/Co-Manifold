...
def var_all_case(model, testloader, patch_size=(128, 128, 96), save_result=False, test_save_path=None):
    ith = 0
    total_metric = 0.0
...
def test_all_case(model, testloader, patch_size=(128, 128, 96), save_result=True, test_save_path=None):
    ith = 0
    total_metric = 0.0
    total_metric_average = 0.0
    metrics_list = []
