...
def test_all_case(model_name, model_num, model, image_list, num_classes, patch_size=(112, 112, 80), stride_xy=18,
    ...
    with open(test_save_path + '../{}_performance_{}.txt'.format(model_name, str(model_num)), 'w') as f:
