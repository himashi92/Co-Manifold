...
class VNet_H(nn.Module):
    def __init__(self, manifold, n_channels=3, n_classes=2, n_filters=16, normalization='none', has_dropout=False,
                 has_residual=False):
    ...
    def forward(self, input):
        ...
        out_seg1_h = self.manifold.expmap0(out_seg1)
